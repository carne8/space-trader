...
impl SystemType {
    pub fn color(&self) -> (u8, u8, u8) {
        match self {
            Self::NeutronStar => (255, 0, 0),
            Self::RedStar => (255, 0, 0),
            Self::OrangeStar => (255, 165, 0),
            Self::BlueStar => (0, 0, 255),
            Self::YoungStar => (255, 255, 0),
            Self::WhiteDwarf => (255, 255, 255),
            Self::BlackHole => (0, 0, 0),
            Self::Hypergiant => (255, 0, 255),
            Self::Nebula => (128, 128, 128),
            Self::Unstable => (255, 0, 0),
        }
    }
}
